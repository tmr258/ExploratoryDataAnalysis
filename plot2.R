...
presentation_data <- household_df[((household_df[,"Date"]== day1) | (household_df[,"Date"]== day2)), c("Date", "Time", "Global_active_power")]
...
# Plot the variable Global Active Power as function of the time series
